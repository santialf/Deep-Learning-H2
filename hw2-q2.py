...
class CNN(nn.Module):
    ...
    def __init__(self, dropout_prob):
        ...
        self.fc1 = nn.Linear(576, 600) # 576 = 16*6*6
    ...
    def forward(self, x):
        ...
        # Convolution with 5x5 filter with padding to preserve initial image size and 8 channels =>
        #     x.shape = [8, 8, 28, 28]
        # Max pooling with stride of 2 =>
        #     x.shape = [8, 8, 14, 14]
        
        x = F.relu(F.max_pool2d(self.conv2(x), 2, stride=2))
        # Convolution with 3x3 filter with padding of 0 and 16 channels =>
        #     x.shape = [8, 16, 12, 12]
        # Max pooling with stride of 2 =>
        #     x.shape = [8, 16, 6, 6]
